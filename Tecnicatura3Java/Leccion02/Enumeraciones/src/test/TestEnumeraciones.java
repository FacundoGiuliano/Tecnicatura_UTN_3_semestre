...
public class TestEnumeraciones {
    public static void main(String[] args) {
        ...
        //indicarDiaSemana(Dias.MARTES); // Las enumeraciones se tratan como cadenas, no se usan comillas. Se accede a traves del " . "
        ...
        System.out.println("No. de  habitantes en el 3 er continente: "
        ...
        System.out.println("Continen No. 5: "+Continentes.OCEANIA);
    ...
    private static void indicarDiaSemana(Dias dias) {
        switch(dias) {
                ...
                case MARTES:
                    ...
                    break;
                case MIERCOLES:
                    System.out.println("Terer dia de la semana");
                    break;
                case JUEVES:
